...
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH1 1
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH2 2
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH3 3
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH4 4
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH5 5
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH6 6
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH7 7
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH8 8
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH9 9
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH10 10
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH11 11
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH12 12
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH13 13
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH14 14
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH15 15
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH16 16
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH17 17
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH18 18
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH19 19
scoreboard players set @e[type=armor_stand,tag=hunter,limit=1] HMH20 20
